...
const ContactForm = () => {
  ...
  return (
    <div className="flex rounded-2xl bg-[#D0D0D0] p-5">
      <form className="relative w-full" onSubmit={handleSubmit(onSubmit)}>
            ...
            <span className="text-xs  text-white">
              *Sunt de acord cu
              <a
                ...
                className=" mx-2 my-4 text-gri-bg underline underline-offset-4"
              >
        ...
        <div className="flex flex-col items-center justify-center gap-2 text-rosu-brand">
          ...
          {errors.dataNastere && (
            <span>Trebuie sa adaugati o data de nastere</span>
          )}
          {errors.email && <span>Trebuie sa adaugati o adresa de email</span>}
          {errors.telefon && (
            <span>Trebuie sa adaugati un numar de telefon</span>
          )}
          {errors.privacy && (
            <span>
              Trebuie sa fiti de acord cu politica de confidentialitate
            </span>
          )}
        </div>
        <div className="flex w-full items-center justify-center">
          <button
            className="mt-5 rounded-2xl  bg-gri-brand px-5 py-4 text-alb-site"
            type="submit"
          >
            Trimite datele
          </button>
