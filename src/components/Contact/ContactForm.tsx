    ...
    return (
        <div className="flex rounded-2xl bg-[#D0D0D0] p-5">
            <form className="w-full relative" onSubmit={handleSubmit(onSubmit)}>
                ...
                />
                <div className='flex flex-col text-rosu-brand items-center justify-center gap-2'>
                ...
                <div className='flex w-full justify-center items-center'>
                    <button className='mt-5 rounded-2xl  bg-gri-brand text-alb-site px-5 py-4' type="submit">Trimite datele</button></div>
            </form>
        </div>
    );
};
