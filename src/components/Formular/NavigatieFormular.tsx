...
const NavigatieFormular = ({
	...
	const stilComunButon =
		"absolute flex  w-fit items-center justify-center border border-gri-brand gap-3 rounded-2xl px-2 py-2 text-gri-brand md:py-4 md:px-5";
	return (
		<div className="relative flex w-full items-center justify-between px-2 py-12  md:px-16">
			...
			{!isLastStep ? (
				<button
					...
					disabled={disabled}
				>
					<span className="text-sm md:text-lg">Continua</span>{" "}
